...
### 7. 404 页面
- GitHub Pages 自定义 404 页面使用站点当前主题样式
- 已删除文章、隐藏文章、旧链接访问时提示"文章可能已删除、隐藏，或者链接发生变化"
- 提供回首页、`CATEGORY`、`TAG` 入口
- 6 秒后自动回到首页
...
- 支持行内公式 `$...$`
- 支持块级公式 `$$...$$`
- 块级公式会在 Markdown 渲染前被保护，避免公式里的单独 `=` 被误识别成 Markdown 标题
- 前端使用 MathJax 3 渲染 LaTeX 公式，深/浅主题下沿用正文颜色
